...
order_parser.add_argument('action', type=str, required=False, help='Must be BUY, SELL or SHORT', store_missing=False)
...
contract_parser.add_argument('orderType', type=str, required=False, help='Type of Order to place',
                             choices=['LMT', 'MTL', 'MKT PRT', 'QUOTE', 'STP', 'STP LMT', 'TRAIL LIT', 'TRAIL MIT',
                                      ...
                                      'LOC', 'LOO', 'LIT', 'PEG MID', 'VWAP', 'GAT', 'GTD', 'GTC', 'IOC', 'OCA', 'VOL'], store_missing=True)
contract_parser.add_argument('secType', type=str, required=False, default='STK', help='Security Type',
                             choices=['STK', 'OPT', 'FUT', 'IND', 'FOP', 'CASH', 'BAG', 'NEWS'], store_missing=True)
contract_parser.add_argument('exchange', type=str, required=False, default='SMART', help='Exchange (ie NASDAQ, SMART)', store_missing=True)
contract_parser.add_argument('currency', type=str, required=False, default='USD',
                             help='Currency used for order (ie USD, GBP))', store_missing=True)